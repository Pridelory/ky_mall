...
public enum NewBeeMallOrderStatusEnum {
    ...
    public static com.wangmeng.mall.common.NewBeeMallOrderStatusEnum getNewBeeMallOrderStatusEnumByStatus(int orderStatus) {
        for (com.wangmeng.mall.common.NewBeeMallOrderStatusEnum newBeeMallOrderStatusEnum : com.wangmeng.mall.common.NewBeeMallOrderStatusEnum.values()) {
